...
public class GeneralWD {
    ...
    public static void quitDriver()
    {
        ...
        if (threadDriver.get() != null)  // dolu ise
        {
            ...
            // içindeki elemanı getle alıp null a eşitleyip kendisine tekrar set ile geri verdim
            threadDriver.set(driver);
        }
    }

    public static void setThreadBrowserName(String browserName) {
        GeneralWD.threadBrowserName.set(browserName);
    }


    public static String getThreadBrowserName() {
        return GeneralWD.threadBrowserName.get();
    }
}
